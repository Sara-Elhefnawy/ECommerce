...
public interface ICache<T> where T : class 
{
    ...
    Task<ResultOfT<T?>> GetAsync(string cacheKey, CancellationToken ct = default);

    Task<ResultOfT<T>> GetOrCreateAsync(
    ...
    Task<Result> SetAsync(string cacheKey, T value, CancellationToken ct = default);

    Task<Result> RemoveAsync(string cacheKey, CancellationToken ct = default);
}
