...
public static class OrderErrors
{
    ...
    public static readonly Error DeliveryMethodRequired =
        Error.Validation(
            "Order.DeliveryMethodRequired", 
            "Delivery method is required.");

    public static readonly Error DeliveryMethodUnavailable =
        Error.Validation(
            "Order.DeliveryMethodUnavailable", 
    ...
    public static readonly Error ShippingAddressNotFound =
        Error.NotFound(
            "Order.ShippingAddressNotFound", 
            "Shipping address was not found.");

    public static readonly Error ShippingAddressNotOwned =
        Error.Forbidden(
            "Order.ShippingAddressNotOwned", 
            "Shipping address does not belong to the current user.");

    public static readonly Error InvalidShippingName =
        Error.Validation(
            "Order.InvalidShippingName", 
            "Shipping recipient name is required.");

    public static readonly Error InvalidShippingPhone =
        Error.Validation(
            "Order.InvalidShippingPhone", 
            "Shipping phone number is required.");

    public static readonly Error InvalidShippingLocation =
        Error.Validation(
            "Order.InvalidShippingLocation", 
            "Shipping country, city and street are required.");

    public static readonly Error InvalidShippingPostalCode =
        Error.Validation(
